...
[Electric Border (iOS Safe)](https://codepen.io/BalintFerenczy/pen/yyYErXa) by [Bálint Ferenczy](https://codepen.io/BalintFerenczy)`,
  ...
  {
    name: 'Glassmorphic Flashcard',
    route: 'glassmorphic-flashcard',
    description: 'A sleek flashcard component with backdrop blur, flip animation, and a dedicated word layer.',
  ...
  <div class="flashcard-demo">
    ...
    <div class="cards-stack">
      <GlassmorphicFlashcard
        imageUrl="/glassmorphic-flashcard/casa.webp"
        :aspectRatioForNamerFlashcard="217 / 232"
        frontTagText="Italian"
        word="Casa"
        definition="Un edificio o una abitazione in cui vivono una o più persone."
        audioUrl="/glassmorphic-flashcard/casa.wav"
        lampColorForNamerFlashcard="#4776cb"
      />
      <GlassmorphicFlashcard
        imageUrl="/glassmorphic-flashcard/chiesa.webp"
        :aspectRatioForNamerFlashcard="51 / 60"
        frontTagText="Italian"
        word="Chiesa"
        definition="Un edificio dedicato al culto cristiano."
        audioUrl="/glassmorphic-flashcard/chiesa.wav"
        lampColorForNamerFlashcard="#a19fe5"
      />
      <GlassmorphicFlashcard
        imageUrl="/glassmorphic-flashcard/conigli.webp"
        :aspectRatioForNamerFlashcard="1 / 1"
        frontTagText="Animals"
        word="Conigli"
        definition="Piccoli mammiferi erbivori con orecchie lunghe e coda corta."
        audioUrl="/glassmorphic-flashcard/conigli.wav"
        lampColorForNamerFlashcard="#6cc606"
      />
    </div>
  </div>
</template>
...
<script setup>
import GlassmorphicFlashcard from './GlassmorphicFlashcard.vue'
</script>
...
.demo-bg {
  position: absolute;
  inset: 0;
  background-image: url('/glassmorphic-flashcard/background.webp');
  background-size: cover;
  background-position: center;
  background-repeat: no-repeat;
  z-index: 0;
...
// Note: The GlassmorphicFlashcard component accepts the following props:
// - widthForNamerFlashcard: number (optional) - Width of the card in pixels (default: 412).
// - aspectRatioForNamerFlashcard: number (optional) - Aspect ratio used to calculate card height (default: 217 / 241).
// - maxWidthForNamerFlashcard: number|string (optional) - Maximum width of the card container (default: 412).
// - paddingForNamerFlashcard: string (optional) - Padding inside the card content (default: "16px").
// - cardRadiusForNamerFlashcard: string (optional) - Border radius of the card body (default: "24px").
// - cardBlurForNamerFlashcard: number (optional) - Backdrop blur on the card body (default: 7.64).
// - cardBodyColorForNamerFlashcard: string (optional) - Background color of the front card face (default: "rgba(10, 10, 10, 0.36)").
// - cardBorderColorForNamerFlashcard: string (optional) - Border color of the card body (default: "rgba(255, 255, 255, 0.12)").
// - cardBorderWidthForNamerFlashcard: string (optional) - Border width of the card body (default: "1px").
// - overlayColorForNamerFlashcard: string (optional) - Overlay color on the front image (default: "rgba(0, 0, 0, 0.12)").
// - backGradientFromForNamerFlashcard: string (optional) - Top color of the back face gradient (default: "rgba(20, 20, 20, 0.84)").
// - backGradientToForNamerFlashcard: string (optional) - Bottom color of the back face gradient (default: "rgba(10, 10, 10, 0.9)").
// - imageUrl: string (optional) - URL of the front image (default: "").
// - word: string (optional) - Main word displayed on the back face (default: "").
// - definition: string (optional) - Definition text displayed on the back face (default: "").
// - isRTL: boolean (optional) - Enables right-to-left layout direction (default: false).
// - revealText: string (optional) - Text shown on the front face reveal button (default: "Reveal").
// - hideText: string (optional) - Text shown on the back face hide button (default: "Hide").
// - audioButtonText: string (optional) - Text shown on the audio button (default: "Listen").
// - showAudioButton: boolean (optional) - Whether to display the audio button (default: true).
// - audioUrl: string (optional) - URL of the audio file to play (default: "").
// - frontTagText: string (optional) - Custom label for the front tag (default: "").
// - backTagText: string (optional) - Custom label for the back tag (default: "").
// - tagBgColorForNamerFlashcard: string (optional) - Background color of the tag pill (default: "rgba(0, 0, 0, 0.36)").
// - tagBorderColorForNamerFlashcard: string (optional) - Border color of the tag pill (default: "rgba(255, 255, 255, 0.12)").
// - tagBorderRadiusForNamerFlashcard: string (optional) - Border radius of the tag pill (default: "12px").
// - tagPaddingForNamerFlashcard: string (optional) - Padding inside the tag pill (default: "8px 12px").
// - tagBlurForNamerFlashcard: number (optional) - Backdrop blur used on the tag pill (default: 12).
// - tagFontSizeForNamerFlashcard: string (optional) - Font size of the tag text (default: "11px").
// - tagFontWeightForNamerFlashcard: string (optional) - Font weight of the tag text (default: "700").
// - tagFontColorForNamerFlashcard: string (optional) - Text color of the tag text (default: "#ffffff").
// - tagTextLetterSpacingForNamerFlashcard: string (optional) - Letter spacing of the tag text (default: "0.01em").
// - tagAlignForNamerFlashcard: string (optional) - Horizontal alignment of the tag container; supports flex-start, center, or flex-end (default: "flex-start").
// - wordFontSizeForNamerFlashcard: string (optional) - Font size of the word heading (default: "2.25rem").
// - wordFontWeightForNamerFlashcard: string (optional) - Font weight of the word heading (default: "700").
// - wordColorForNamerFlashcard: string (optional) - Text color of the word heading (default: "#ffffff").
// - wordMarginForNamerFlashcard: string (optional) - Margin applied to the word heading (default: "0").
// - definitionFontSizeForNamerFlashcard: string (optional) - Font size of the definition text (default: "14px").
// - definitionColorForNamerFlashcard: string (optional) - Text color of the definition text (default: "rgba(255, 255, 255, 0.6)").
// - definitionLineHeightForNamerFlashcard: string (optional) - Line height of the definition text (default: "1.6").
// - definitionMaxWidthForNamerFlashcard: string (optional) - Maximum width of the definition text (default: "280px").
// - definitionFontStyleForNamerFlashcard: string (optional) - Font style of the definition text (default: "italic").
// - wordAreaAlignForNamerFlashcard: string (optional) - Alignment of the word/definition block; supports flex-start, center, or flex-end (default: "center").
// - lampColorForNamerFlashcard: string (optional) - Color of the separator lamp line (default: "#752bff").
// - lampWidthForNamerFlashcard: string (optional) - Default width of the separator lamp line (default: "60%").
// - lampOpacityForNamerFlashcard: number (optional) - Default opacity of the separator lamp line (default: 0.4).
// - lampHoverWidthForNamerFlashcard: string (optional) - Hover width of the separator lamp line (default: "80%").
// - lampHoverOpacityForNamerFlashcard: number (optional) - Hover opacity of the separator lamp line (default: 0.64).
// - showDots: boolean (optional) - Whether to display the dot-pattern layer on the back face (default: true).
// - dotsOpacityForNamerFlashcard: number (optional) - Opacity of the dot-pattern layer (default: 0.65).
// - dotsColorForNamerFlashcard: string (optional) - Dot color used in the back pattern (default: "rgba(255, 255, 255, 0.1)").
// - dotsSizeForNamerFlashcard: string (optional) - Spacing for the dot pattern tiles (default: "1.3rem").
// - buttonBgColorForNamerFlashcard: string (optional) - Background color of the glass buttons (default: "rgba(255, 255, 255, 0.05)").
// - buttonBgHoverColorForNamerFlashcard: string (optional) - Hover background color of the glass buttons (default: "rgba(255, 255, 255, 0.16)").
// - buttonBorderColorForNamerFlashcard: string (optional) - Border color of the glass buttons (default: "rgba(255, 255, 255, 0.12)").
// - buttonBorderHoverColorForNamerFlashcard: string (optional) - Hover border color of the glass buttons (default: "rgba(255, 255, 255, 0.24)").
// - buttonBorderWidthForNamerFlashcard: string (optional) - Border width of the glass buttons (default: "1px").
// - buttonBorderRadiusForNamerFlashcard: string (optional) - Border radius of the glass buttons (default: "12px").
// - buttonPaddingForNamerFlashcard: string (optional) - Padding of the glass buttons (default: "12px 14px").
// - buttonFontSizeForNamerFlashcard: string (optional) - Font size of the glass buttons (default: "13px").
// - buttonFontWeightForNamerFlashcard: string (optional) - Font weight of the glass buttons (default: "700").
// - buttonLetterSpacingForNamerFlashcard: string (optional) - Letter spacing of the glass buttons (default: "0.01em").
// - buttonTextColorForNamerFlashcard: string (optional) - Text color of the glass buttons (default: "#ffffff").
// - buttonBlurForNamerFlashcard: number (optional) - Backdrop blur applied to the glass buttons (default: 12).
// - frontButtonBottomPaddingForNamerFlashcard: string (optional) - Bottom padding for the front button wrapper (default: "32px").
// - audioButtonBgColorForNamerFlashcard: string (optional) - Optional override for the audio button background (default: "").
// - audioButtonBorderColorForNamerFlashcard: string (optional) - Optional override for the audio button border (default: "").
// - audioButtonPaddingForNamerFlashcard: string (optional) - Padding for the audio button (default: "10px 20px").
// - audioButtonFontSizeForNamerFlashcard: string (optional) - Font size for the audio button (default: "11px").
// - audioButtonBorderRadiusForNamerFlashcard: string (optional) - Border radius for the audio button (default: "50px").
// - audioButtonFontWeightForNamerFlashcard: string (optional) - Font weight for the audio button (default: "700").
// - audioButtonTextColorForNamerFlashcard: string (optional) - Text color for the audio button (default: "#ffffff").
// - audioIconSizeForNamerFlashcard: string (optional) - SVG icon size for the audio button (default: "14").
// - audioIconStrokeWidthForNamerFlashcard: number (optional) - Stroke width for the audio icon (default: 2).
// - audioIconColorForNamerFlashcard: string (optional) - Color of the audio icon wrapper (default: "#ffffff").
// - modelValue: boolean (optional) - Controls the flipped state when used as a v-model prop (default: undefined).
//
// Emits:
// - update:modelValue
//
...
`,
    code: [
      {
        filename: 'GlassmorphicFlashcard.vue',
        content: `<template>
  <div
...
.namerFlashcardGlassButton:focus-visible {
  outline: none;
    ...
    credit: `[Glass Cards](https://codepen.io/RAFA3L/pen/NPKeYMo) by [Rafa](https://codepen.io/RAFA3L)
...
[Accent Shard (On Hover)](https://codepen.io/Hyperplexed/pen/qBMYVoq) by [Hyperplexed](https://codepen.io/Hyperplexed)
  ...
  - Photo by [Abby Rurenko](https://unsplash.com/@walking_abby?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText) on [Unsplash](https://unsplash.com/photos/brown-and-white-concrete-house-uOYak90r4L0?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText)
  - Photo by [Vjekoslav Domanović](https://unsplash.com/@vjeblackbirdlion?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText) on [Unsplash](https://unsplash.com/photos/stone-church-with-a-winding-path-BV3ABa1-NI4?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText)
  - Photo by [Samuel Phillips](https://www.pexels.com/@samuel-phillips-2148550424/) from [Pexels](https://www.pexels.com/photo/beautiful-giant-rabbits-relaxing-on-grass-30691525/)
  - Photo by [Ryan Le](https://unsplash.com/@ryan_le?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText) on [Unsplash](https://unsplash.com/photos/an-aerial-view-of-a-city-at-night-BFmczCWWW3o?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText)

Credit for the sounds can be found [here](https://github.com/Northstrix/onda-sfasata)`,
    previewType: 'image',
